...
public class CustomTestNGReporter implements IReporter {
	...
	private static final String emailableReportTemplateFile = "../testCalculator/src/test/java/CustomTestNGReporter/customize-emailable-report-template.html";
